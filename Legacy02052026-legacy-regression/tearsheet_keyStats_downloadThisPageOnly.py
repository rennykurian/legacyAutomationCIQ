...
async def generate_save_excel_tearsheet_KeyStats_thisPageOnly():
    playwright = None
    browser = None
    page = None
    ...
    try:
        ...
        # ----------------------------
        # DOWNLOAD (UPDATED - BEST METHOD)
        # ----------------------------
        print("📥 Starting Excel download...")

        #download_link = page.locator("#_pageHeader__singleTabReport")
        download_link = page.locator("a[title='Download Key Stats to Excel']")
...
if __name__ == "__main__":
    asyncio.run(generate_save_excel_tearsheet_KeyStats_thisPageOnly())