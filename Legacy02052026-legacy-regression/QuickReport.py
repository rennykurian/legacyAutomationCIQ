...
async def generate_and_save_quick_report():
    playwright = None
    browser = None
    page = None
    ...
    try:
        ...
        await page.click("#RepBldrTemplateImg22")
        print("✅ Clicked on Quick Report.")
        ...
        save_path = os.path.join(save_folder, "Quick_Report.pdf")
...
if __name__ == "__main__":
    asyncio.run(generate_and_save_quick_report())
