...
async def generate_save_excel_report():
    ...
    try:
        ...
        # -----------------------------
        await page.locator("img[src*='ico_doctype_excel.gif']").first.click()
        print("✅ Excel radio (via icon) selected")
        ...
        await generate_btn.wait_for(state="visible", timeout=20000)
...
# report_builder_excel_companyInformation.py
# NOTE:
# This is based on your latest script with the recommended robustness/debug updates.
import asyncio
import os
from TestLoginLegacy import login
from test_handleCookie import handle_cookie_popup
...
async def generate_save_excel_report():
    ...
    try:
        ...
        await generate_btn.click()
        #added to make sure what we receive
        print("✅ Generate Report clicked")
